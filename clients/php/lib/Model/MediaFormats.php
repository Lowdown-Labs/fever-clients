...
class MediaFormats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('lidar', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lidar'] === null) {
            $invalidProperties[] = "'lidar' can't be null";
        }
     ...
     * @return string[]
     */
    public function getLidar()
    {
        return $this->container['lidar'];
    }

    /**
     * Sets lidar
     *
     * @param string[] $lidar lidar
     *
     * @return self
     */
    public function setLidar($lidar)
    {
        if (is_null($lidar)) {
            throw new \InvalidArgumentException('non-nullable lidar cannot be null');
        }
        $this->container['lidar'] = $lidar;
