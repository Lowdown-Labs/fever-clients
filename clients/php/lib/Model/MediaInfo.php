...
class MediaInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'attachments' => '\LowdownLabs\Fever\Model\MediaAttachment[]',
        'blob_id' => 'int',
        'caption' => 'string',
     ...
     * Gets attachments
     *
     * @return \LowdownLabs\Fever\Model\MediaAttachment[]|null
     */
     ...
     * Sets attachments
     *
     * @param \LowdownLabs\Fever\Model\MediaAttachment[]|null $attachments Related items pointing at this blob via parent_ref (e.g. a LiDAR scan attached to the photo or video it belongs to).
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind Media kind of this blob (image/video/audio/pdf/doc/note/lidar).
     *
     * @return self
     */
