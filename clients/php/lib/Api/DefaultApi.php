...
class DefaultApi
{
     ...
     * @return \LowdownLabs\Fever\Model\Health
     */
     ...
     * @throws \LowdownLabs\Fever\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LowdownLabs\Fever\Model\Health, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation healthzHealthzGet
     *
     * Healthz
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthzHealthzGet'] to see the possible values for this operation
     *
     * @throws \LowdownLabs\Fever\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed
    ...
    /**
     * Operation healthzHealthzGetWithHttpInfo
     *
     * Healthz
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthzHealthzGet'] to see the possible values for this operation
    ...
    /**
     * Operation healthzHealthzGetAsync
     *
     * Healthz
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthzHealthzGet'] to see the possible values for this operation
    ...
    /**
     * Operation healthzHealthzGetAsyncWithHttpInfo
     *
     * Healthz
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthzHealthzGet'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'healthzHealthzGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthzHealthzGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
