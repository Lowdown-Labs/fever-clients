...
**exclude_tags** | **string[]** | Exclude blobs carrying any of these tags (ingest tags and/or zero-shot autotags), e.g. [&#39;people&#39;] to build a no-people dataset. | [optional]
...
**include_tags** | **string[]** | Only blobs carrying at least one of these tags (ANY semantics: e.g. a list of geo:&lt;place&gt; tags an integrator&#39;s UI offers). Combine with exclude_tags as you like. | [optional]
...
**near** | **float[]** | Geo filter [lat, lon, radius_km] from EXIF GPS. | [optional]
