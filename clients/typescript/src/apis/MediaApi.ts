...
import {
    ...
    AssociateRequestFromJSON,
    AssociateRequestToJSON,
} from '../models/AssociateRequest';
import {
...
export class MediaApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for associateMedia without sending the request
     */
    async associateMediaRequestOpts(requestParameters: AssociateMediaRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['blobId'] == null) {
            throw new runtime.RequiredError(
                'blobId',
                'Required parameter "blobId" was null or undefined when calling associateMedia().'
            );
        }

        if (requestParameters['associateRequest'] == null) {
            throw new runtime.RequiredError(
                'associateRequest',
                'Required parameter "associateRequest" was null or undefined when calling associateMedia().'
            );
        }
        ...
        let urlPath = `/v1/media/{blob_id}/associate`;
        ...
        return {
            ...
            body: AssociateRequestToJSON(requestParameters['associateRequest']),
        };
    }
     ...
     */
    async associateMediaRaw(requestParameters: AssociateMediaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MediaInfo>> {
        const requestOptions = await this.associateMediaRequestOpts(requestParameters);
     ...
     * Set a blob\'s collection and/or parent association (e.g. attach a LiDAR scan to its source photo)
     */
    async associateMedia(requestParameters: AssociateMediaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MediaInfo> {
        const response = await this.associateMediaRaw(requestParameters, initOverrides);
