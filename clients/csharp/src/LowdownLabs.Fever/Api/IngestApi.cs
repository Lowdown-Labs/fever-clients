...
namespace LowdownLabs.Fever.Api
{
    ...
    public partial class IngestApi : IDisposable, IIngestApi
    {
        ...
        /// <summary>
        /// Ingest one or many media items Throw 1..N media items over the wall. Small inline batches are embedded and indexed synchronously and return blob ids; large batches or an s3:// source return a Job you poll at /v1/jobs/{id}. Tenant is taken from the API key.
        /// </summary>
        /// <exception cref="LowdownLabs.Fever.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ingestRequest"></param>
        /// <returns>IngestResult</returns>
