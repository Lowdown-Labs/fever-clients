...
// SetAttachments gets a reference to the given []MediaAttachment and assigns it to the Attachments field.
...
func (o *MediaInfo) SetCollectionIdNil() {
...
func (o *MediaInfo) SetParentRefNil() {
	o.ParentRef.Set(nil)
}
