...
// checks if the CorpusStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CorpusStats{}

// CorpusStats struct for CorpusStats
...
// GetTopTags returns the TopTags field value
...
// GetTopTagsOk returns a tuple with the TopTags field value
// and a boolean to check if the value has been set.
