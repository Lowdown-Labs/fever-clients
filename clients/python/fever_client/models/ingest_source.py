...
class IngestSource(BaseModel):
    ...
    IngestSource
    """ # noqa: E501
    collection_id: Optional[StrictStr] = Field(default=None, description="Tag every vacuumed item with this collection_id.")
    ...
    __properties: ClassVar[List[str]] = ["collection_id", "customer_id", "s3_uri", "target_res"]
