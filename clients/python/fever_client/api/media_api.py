...
class MediaApi:
    ...
    async def associate_media(
        ...
        :type blob_id: int
        :param associate_request: (required)
        :type associate_request: AssociateRequest
        :param customer_id:
        ...
        _param = self._associate_media_serialize(
            blob_id=blob_id,
    ...
    @validate_call
    async def associate_media_with_http_info(
        self,
        blob_id: StrictInt,
        associate_request: AssociateRequest,
        customer_id: Optional[StrictStr] = None,
    ...
    @validate_call
    async def associate_media_without_preload_content(
        self,
        blob_id: StrictInt,
        associate_request: AssociateRequest,
        customer_id: Optional[StrictStr] = None,
    ...
    def _associate_media_serialize(
        self,
        blob_id,
        associate_request,
        customer_id,
        ...
        if associate_request is not None:
            _body_params = associate_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/media/{blob_id}/associate',
