...
from fever_client.configuration import Configuration
from fever_client.api_response import ApiResponse, T as ApiResponseT
import fever_client.models
from fever_client import rest
from fever_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fever_client.models, klass)
