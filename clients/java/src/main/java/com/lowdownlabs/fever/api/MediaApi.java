...
public class MediaApi {
   ...
   * @param associateRequest  (required)
   * @param customerId  (optional)
   * @return MediaInfo
   * @throws ApiException if fails to make API call
   */
  public MediaInfo associateMedia(@javax.annotation.Nonnull Integer blobId, @javax.annotation.Nonnull AssociateRequest associateRequest, @javax.annotation.Nullable String customerId) throws ApiException {
    return associateMedia(blobId, associateRequest, customerId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public MediaInfo associateMedia(@javax.annotation.Nonnull Integer blobId, @javax.annotation.Nonnull AssociateRequest associateRequest, @javax.annotation.Nullable String customerId, Map<String, String> headers) throws ApiException {
    ApiResponse<MediaInfo> localVarResponse = associateMediaWithHttpInfo(blobId, associateRequest, customerId, headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MediaInfo> associateMediaWithHttpInfo(@javax.annotation.Nonnull Integer blobId, @javax.annotation.Nonnull AssociateRequest associateRequest, @javax.annotation.Nullable String customerId) throws ApiException {
    return associateMediaWithHttpInfo(blobId, associateRequest, customerId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MediaInfo> associateMediaWithHttpInfo(@javax.annotation.Nonnull Integer blobId, @javax.annotation.Nonnull AssociateRequest associateRequest, @javax.annotation.Nullable String customerId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = associateMediaRequestBuilder(blobId, associateRequest, customerId, headers);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("associateMedia", localVarResponse);
        }
  ...
  private HttpRequest.Builder associateMediaRequestBuilder(@javax.annotation.Nonnull Integer blobId, @javax.annotation.Nonnull AssociateRequest associateRequest, @javax.annotation.Nullable String customerId, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'blobId' is set
    if (blobId == null) {
      throw new ApiException(400, "Missing the required parameter 'blobId' when calling associateMedia");
    }
    // verify the required parameter 'associateRequest' is set
    if (associateRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'associateRequest' when calling associateMedia");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/media/{blob_id}/associate"
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(associateRequest);
