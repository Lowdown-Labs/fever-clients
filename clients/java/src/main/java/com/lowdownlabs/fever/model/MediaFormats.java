...
@JsonPropertyOrder({
  ...
  MediaFormats.JSON_PROPERTY_LIDAR,
...
public class MediaFormats {
  ...
  public static final String JSON_PROPERTY_LIDAR = "lidar";
  @javax.annotation.Nonnull
  private List<String> lidar = new ArrayList<>();
  ...
  public MediaFormats lidar(@javax.annotation.Nonnull List<String> lidar) {
    this.lidar = lidar;
    return this;
  }

  public MediaFormats addLidarItem(String lidarItem) {
    if (this.lidar == null) {
      this.lidar = new ArrayList<>();
    }
    this.lidar.add(lidarItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_LIDAR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<String> getLidar() {
    return lidar;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LIDAR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLidar(@javax.annotation.Nonnull List<String> lidar) {
    this.lidar = lidar;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.audio, mediaFormats.audio) &&
        ...
        Objects.equals(this.lidar, mediaFormats.lidar) &&
        Objects.equals(this.video, mediaFormats.video);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audio, document, image, lidar, video);
  }
  ...
  public String toString() {
    ...
    sb.append("    lidar: ").append(toIndentedString(lidar)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `lidar` to the URL query string
    if (getLidar() != null) {
      for (int i = 0; i < getLidar().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%slidar%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getLidar().get(i)))));
      }
    }
