...
| [**healthWithHttpInfo**](DefaultApi.md#healthWithHttpInfo) | **GET** /v1/health | Health check |
| [**healthzHealthzGet**](DefaultApi.md#healthzHealthzGet) | **GET** /healthz | Healthz |
| [**healthzHealthzGetWithHttpInfo**](DefaultApi.md#healthzHealthzGetWithHttpInfo) | **GET** /healthz | Healthz |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling DefaultApi#healthzHealthzGet");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
