...
| ---- | ---- | ----------- | ----- |
| **attachments** | [**Array&lt;MediaAttachment&gt;**](MediaAttachment.md) | Related items pointing at this blob via parent_ref (e.g. a LiDAR scan attached to the photo or video it belongs to). | [optional] |
| **blob_id** | **Integer** |  |  |
