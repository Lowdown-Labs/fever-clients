# FeverClient::QueryRequest

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **row_limit** | **Integer** | Max rows to return; capped at 1000 regardless of what&#39;s requested. A LIMIT already in the sql, if smaller, is honored instead. | [optional][default to 200] |
...
instance = FeverClient::QueryRequest.new(
  row_limit: null,
  sql: null
)
```
