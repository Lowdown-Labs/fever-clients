...
module FeverClient
  class MediaInfo < ApiModelBase
    ...
    def hash
      [attachments, blob_id, caption, captured_at, collection_id, customer_id, device, external_ref, frame_count, gps_lat, gps_lon, kind, metadata, ocr_text, parent_ref, synthetic, tags, transcript_segments].hash
    end
