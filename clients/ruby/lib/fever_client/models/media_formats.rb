...
module FeverClient
  class MediaFormats < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'lidar')
        if (value = attributes[:'lidar']).is_a?(Array)
          self.lidar = value
        end
      else
        self.lidar = nil
    ...
    def list_invalid_properties
      ...
      if @lidar.nil?
        invalid_properties.push('invalid value for "lidar", lidar cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] lidar Value to be assigned
    def lidar=(lidar)
      if lidar.nil?
        fail ArgumentError, 'lidar cannot be nil'
      end
    ...
    def hash
      [audio, document, image, lidar, video].hash
    end
